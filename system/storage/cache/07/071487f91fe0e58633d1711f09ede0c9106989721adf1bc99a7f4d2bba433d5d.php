...
class __TwigTemplate_0bd73b6d3f50b05bd062ca576c912df7c82a44688ec4d2a2e978a2acd13c1c6f extends Twig_Template
{
...
/*         <div class="col-sm-2"><img src="{{ thumb }}" alt="{{ image_alt ? image_alt : heading_title }}" title="{{ image_title ? image_title : heading_title }}" class="img-thumbnail" /></div>*/
/*         {% endif %}*/
/*         {% if description %}*/
