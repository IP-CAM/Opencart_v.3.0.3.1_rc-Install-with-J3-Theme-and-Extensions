...
// Заголовок
$_['heading_title']		  				= '<img src="view/seo_package/img/icon.png" style="vertical-align:top;padding-right:4px"/><span style="color:#11b209">Complete SEO</span> <span style="color:#555">Package</span> <a href="https://prowebber.ru/" target="_blank" style="color:#233746"><i class="fa fa-file-code-o"></i></a> ';
...
$_['text_fpp_mode_help']   			= '<span class="help"><b>рямая ссылка:</b> Прямая ссылка на продукт, категория не включена (прим: /product_name), это станадртное значение опенкарта<br/>
